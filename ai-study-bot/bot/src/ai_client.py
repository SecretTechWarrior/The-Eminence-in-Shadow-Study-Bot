...
try:
    ...
    _GEMINI_ERROR = str(e)
    logger.warning(f"Gemini disabled: {_GEMINI_ERROR}")


# =========================================================
# LAZY CLIENTS (IMPORTANT FOR RAILWAY STABILITY)
# =========================================================
...
async def ask_gemini(prompt: str, system: str = None) -> str:
    if not GEMINI_AVAILABLE or genai is None:
        raise RuntimeError(f"Gemini unavailable: {_GEMINI_ERROR}")
...
# =========================================================
# MAIN AI ROUTER (SAFE FALLBACK CHAIN)
# =========================================================
async def ask_ai(prompt: str, system: str = None, prefer: str = "openrouter") -> str:
    """
    Safe fallback chain:
    openrouter -> groq -> gemini (if available)
    """
    ...
    if prefer == "gemini":
        ...
        order = [ask_openrouter, ask_groq, ask_gemini]
